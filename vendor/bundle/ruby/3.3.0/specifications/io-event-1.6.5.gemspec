...
Gem::Specification.new do |s|
  ...
  s.authors = ["Samuel Williams".freeze, "Math Ieu".freeze, "Wander Hillen".freeze, "Benoit Daloze".freeze, "Bruno Sutic".freeze, "Alex Matchneer".freeze, "Delton Ding".freeze, "Pavel Rosick\u00FD".freeze]
